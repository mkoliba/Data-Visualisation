// parse the date data to the right forma
var parseTime = d3.timeParse("%Y-%m-%d")

var Converter = function (d){
  return{
  TripDate : parseTime(d.starttime),

}
}
  //  StartTripDate: parseDate(d.starttime),
  //  StartTripHour: d.starttime.split(" ")[1],
  //}


//sorting date values
function sortByHourAscending(a, b) {
    return a.StartTripHour - b.StartTripHour;
}

d3.csv("data/201803_citibikenyc_tripdata.csv",Converter,function(error, data) {
  console.log(data[1])
	  // var HourCount = d3.nest()
        	//		.key(function(d) {return d.StartTripHour; })
...
function draw(Day) {
  //Count the trips for each hour of this Day

  DayData = data.filter(d.StartTripDdate==Day)
   .key(function(d) { return d.StartTripDdate; })
   .entries(Data1);
...
//d3.queue()
  ...
  //  .await(function(error, d1, d2, d3, d4, d5, d6, d7,d8,d9,d10) {
        //data['2009'] = d2009;
        //data['2010'] = d2010;
        //data['2011'] = d2011;
        //data['2012'] = d2012;
